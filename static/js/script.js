...
$("#menuss").on("click", "a", function(e) {
    // Get the ID of the clicked element
	var previousActiveId = $(".child.active").attr("id");
    console.log(previousActiveId)
	$("#" + previousActiveId).removeClass("active");

    // Get the ID of the clicked child element
    var clickedChildId = $(this).attr("id");
	$("#" + clickedChildId).addClass("active");
	$(`.${previousActiveId}`).toggle()
	$(`.${clickedChildId}`).toggle()
...
$('.test').on("click",function(){
  ...
  $('.top-area > .setting-area ').on("click",function(){
	$(this).siblings().children('div').removeClass('active');
	$(this).children('div').addClass('active');
	return false;
  });
